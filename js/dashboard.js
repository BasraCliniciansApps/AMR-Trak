    ...
    <div class="px-3 mt-4 max-w-lg mx-auto">
        ...
        <div id="viewAnalytics" class="space-y-4">
            ...
            <div id="analyticsContainer" class="hidden space-y-4">
                ...
                <div class="mobile-card">
                    <h3 class="text-sm font-bold text-slate-800 mb-3 text-center">Prevalence</h3>
                    <div class="h-48 relative"><canvas id="chartOrg"></canvas></div>
                </div>
                <div class="mobile-card">
                    <h3 class="text-sm font-bold text-slate-800 mb-3 text-center">Specimen</h3>
                    <div class="h-48 relative"><canvas id="chartSpecimen"></canvas></div>
                </div>
                <div class="mobile-card">
                    <h3 class="text-sm font-bold text-slate-800 mb-3 text-center">Gender</h3>
        ...
        <div id="viewLastMonth" class="hidden space-y-4">
            <div class="mobile-card border-t-4 border-t-blue-500">
                ...
                <div class="grid grid-cols-3 gap-2 text-center mb-4">
                    ...
                    <div class="bg-slate-50 p-2 rounded-lg border border-slate-100 min-h-[110px] flex flex-col justify-center">
                        <div class="text-[10px] text-slate-500 font-bold mb-1">Top Spec</div>
                ...
                <div class="grid grid-cols-2 gap-2 mb-4 bg-slate-50 p-3 rounded-lg border border-slate-100">
                    <div>
                        <h4 id="live_m_blood_title" class="text-[10px] font-bold text-center text-red-700 mb-1">Blood Isolates</h4>
                        <div class="h-28 relative"><canvas id="chart_m_blood"></canvas></div>
                    </div>
                    <div>
                        <h4 id="live_m_urine_title" class="text-[10px] font-bold text-center text-yellow-600 mb-1">Urine Isolates</h4>
                        <div class="h-28 relative"><canvas id="chart_m_urine"></canvas></div>
                    </div>
                </div>

                <div class="grid grid-cols-2 gap-2 mb-4 mt-2 bg-slate-50 p-3 rounded-lg border border-slate-100">
                    <div>
                        <h4 id="chart_m_pie_title" class="text-[10px] font-bold text-center text-slate-700 mb-1">Top 5 Pathogens</h4>
                        <div class="h-32 relative"><canvas id="chart_m_pie"></canvas></div>
                    </div>
                    <div>
                        <h4 id="chart_m_bar_title" class="text-[10px] font-bold text-center text-slate-700 mb-1">Top 5 Specimens</h4>
                        <div class="h-32 relative"><canvas id="chart_m_bar"></canvas></div>
                    </div>
                </div>
        ...
        <div id="viewLastQuarter" class="hidden space-y-4">
            <div class="mobile-card border-t-4 border-t-emerald-500">
                ...
                <div class="grid grid-cols-2 gap-2 mb-4 bg-slate-50 p-3 rounded-lg border border-slate-100">
                    <div>
                        <h4 id="live_q_blood_title" class="text-[10px] font-bold text-center text-red-700 mb-1">Blood Isolates</h4>
                        <div class="h-28 relative"><canvas id="chart_q_blood"></canvas></div>
                    </div>
                    <div>
                        <h4 id="live_q_urine_title" class="text-[10px] font-bold text-center text-yellow-600 mb-1">Urine Isolates</h4>
                ...
                <div class="grid grid-cols-2 gap-2 mb-4 mt-2 bg-slate-50 p-3 rounded-lg border border-slate-100">
                    <div>
                        <h4 id="chart_q_pie_title" class="text-[10px] font-bold text-center text-slate-700 mb-1">Top 5 Pathogens</h4>
                        <div class="h-32 relative"><canvas id="chart_q_pie"></canvas></div>
                    </div>
                    <div>
                        <h4 id="chart_q_bar_title" class="text-[10px] font-bold text-center text-slate-700 mb-1">Top 5 Specimens</h4>
                        <div class="h-32 relative"><canvas id="chart_q_bar"></canvas></div>
                    </div>
                </div>
